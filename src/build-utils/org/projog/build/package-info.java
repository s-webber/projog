 ...
 * <p>
 * <ul>
 * <li><code>ant sys-test.generate</code> launches {@link org.projog.build.ProjogTestGenerator} which extracts
 * Prolog syntax contained in the comments of java source files to produce system tests files.</li>
 * <li><code>ant sys-test.run</code> launches {@link org.projog.build.ProjogTestRunner} which runs the
