 ...
 * <li>Create a {@link org.projog.api.QueryResult} by using {@link org.projog.api.QueryStatement#getResult()}.</li>
 * <li>Iterate through all possible solutions to the query by using {@link org.projog.api.QueryResult#next()}.</li>
 * <li>For each solution get the {@link org.projog.core.term.Term} instantiated to a {@link org.projog.core.term.Variable} in the query by calling {@link org.projog.api.QueryResult#getTerm(String)}.</li>
 * </ul>
 */
