...
/* SYSTEM TEST
 ...
 % %EXCEPTION% Could not convert characters to an integer: 'one'
 
 % %QUERY% number_chars(X,1257)
 % %EXCEPTION% As the first argument: X is a variable the second argument needs to be a list but was: 1257 of type: INTEGER
 
 % %QUERY% number_chars( X , ['1','.','2'])
 % %EXCEPTION% Could not convert characters to an integer: '1.2'
 
 % %QUERY% number_chars(-12 ,Y)
 % %EXCEPTION% Could not convert characters to an integer: '-' 
 */
/**
