...
% See https://projog.org/javadoc/org/projog/core/KnowledgeBaseUtils.html#bootstrap(org.projog.core.KnowledgeBase)
...
?- pj_add_predicate(bagof/3, 'org.projog.core.predicate.builtin.compound.CollectionOf/bagOf').
?- pj_add_predicate(setof/3, 'org.projog.core.predicate.builtin.compound.CollectionOf/setOf').
...
?- pj_add_predicate(table/1, 'org.projog.core.predicate.builtin.kb.Tabling').
...
?- pj_add_predicate(random_member/2, 'org.projog.core.predicate.builtin.list.RandomMember').
