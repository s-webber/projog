...
public class SpyPointsTest {
   ...
   public void testSpyPointUpdatesObserver() {
      ...
      sp.logCall(this, StructureFactory.createStructure("test", new Term[] {atom("a")}));
      sp.logExit(this, StructureFactory.createStructure("test", new Term[] {atom("b")}), 1);
      sp.logFail(this, StructureFactory.createStructure("test", new Term[] {atom("c")}));
      sp.logRedo(this, StructureFactory.createStructure("test", new Term[] {atom("d")}));
      ...
      testObject.setSpyPoint(key, true);
      sp.logCall(this, StructureFactory.createStructure("test", new Term[] {atom("z")}));
      sp.logExit(this, StructureFactory.createStructure("test", new Term[] {list(atom("a"), variable("X"))}), 0);
      sp.logFail(this, StructureFactory.createStructure("test", new Term[] {structure("c", EmptyList.EMPTY_LIST, atom("z"), integerNumber(1))}));
      sp.logRedo(this, StructureFactory.createStructure("test", new Term[] {new Variable()}));
