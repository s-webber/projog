...
public class KnowledgeBaseUtilsTest {
   ...
   public void testToArrayOfConjunctions() {
      ...
      assertSame(t.firstArgument(), conjunctions[0]);
      assertSame(t.secondArgument().firstArgument(), conjunctions[1]);
      assertSame(t.secondArgument().secondArgument(), conjunctions[2]);
   }
